...
2. **GitHub Desktop** (optional but recommended) - Makes Git easier
...
**💡 Tip:** Keep Docker Desktop running whenever you're working on the project!
...
3. **Clone the Repository**
   ...
   - Click **"URL"** tab
   - Paste: `https://github.com/twburns88/ISYS57103-Fall25-GroupProject-Thomas-Lalitsingh-Peggy.git`
   - Choose where to save it (remember this location!)
   - Click **"Clone"**

4. **Switch to Main Branch**
   - At the top, you'll see "Current Branch: main" (should already be on main)
   - If not, click the branch dropdown and select **"main"**

### Option B: Download as ZIP (Easiest)

1. Go to: https://github.com/twburns88/ISYS57103-Fall25-GroupProject-Thomas-Lalitsingh-Peggy
2. Click the green **"Code"** button
3. Click **"Download ZIP"**
4. Unzip the file to a location you'll remember (like your Desktop or Documents folder)
5. Rename the folder to just `AI-Project` (removes the `-main` suffix)
...
Navigate to where you saved the project (e.g., `Documents/AI-Project`)
...
**⚠️ Important:** Keep these API keys private! Don't share them publicly.

---

## 🚀 Step 4: Start the Application (2 minutes)

### Using Docker Desktop GUI (Easiest!)
...
1. **Click "Choose File"** and upload any product image (or take a photo with your phone and transfer it)
